...
from .routers import search, sektionen, sitzungen, themen
...
app.include_router(themen.router, prefix="/api/themen", tags=["themen"])
app.include_router(sektionen.router, prefix="/api/sektionen", tags=["sektionen"])
